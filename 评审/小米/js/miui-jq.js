/*
* @Author: VAIO
* @Date:   2017-09-09 18:41:34
* @Last Modified by:   VAIO
* @Last Modified time: 2017-09-17 20:18:23
*/
...
$(function(){
	...
	$('.gouwuche').mouseenter(function(){
		$('#gou-cang').css('height','100');
	}).mouseleave(function(){
		$('#gou-cang').css('height','');
	});
	$('.searchlan').focus(function(){
		$(this).css({'border':'1px solid #ff6700',transition:'.3s'});
		$('.search').css({'border':'1px solid #ff6700',transition:'.3s'});
		$('.searchbox>a').hide();
		$('.search-cang').show();
	}).blur(function(){
		$(this).css({'border':''});
	...
	for(let i=0;i<danpinqu.length;i++){
		...
		Tback.eq(i).hover(function(){$(this).css({'color':'#ff6700'})},function(){$(this).css({'color':''})}).click(function(){fn('dian-right')})
		Tforward.eq(i).hover(function(){$(this).css({'color':'#ff6700'})},function(){$(this).css({'color':''})}).click(function(){fn('dian-left')});
	}

	//dapei
	let dapeis = $('.miui-zhuti:gt(0)');
	let choices = dapeis.children('.yingjian-top').children('span');
